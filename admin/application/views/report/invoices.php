                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-lg-4">
                                            <div>
                                                ...
                                                <input type="text" id="from_date" name="from_date" class="form-control date-field" placeholder="Enter date" data-provider="flatpickr" data-date-format="d-m-Y" readonly/>
                                        ...
                                        <div class="col-lg-4">
                                            <div>
                                                ...
                                                <input type="text" id="to_date" name="to_date" class="form-control date-field" placeholder="Enter date" data-provider="flatpickr" data-date-format="d-m-Y" readonly/>
                                                <div class="invalid-tooltip">Please enter date</div>
                                            </div>
                                        </div>                                        
                                        <!--end row-->
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="model-datatables" class="table table-bordered nowrap table-striped align-middle common_datatable" data-control="report" data-mathod="manage_invoices" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>Invoice Date</th>
                                                <th>Invoice No</th>
