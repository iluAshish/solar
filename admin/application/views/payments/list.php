				...
				<div class="card-header border-0 pt-6">
				    ...
				    <div class="card-toolbar">
						...
						<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
							<a href="<?php echo base_url(); ?>payments/cashfree" class="btn btn-light-success">Cashfree Payments</a>
							<button type="button" class="btn btn-light-primary open_my_form_form ml-4" data-control="payments"><i class="ki-duotone ki-plus-square fs-3">
												<span class="path1"></span>
												<span class="path2"></span>
												<span class="path3"></span>
											</i>Add Payments</button>
							<!--end::Add customer-->
						</div>
						<!--end::Toolbar-->
					</div>
