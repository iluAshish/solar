...
$district_name = array('name' => 'district_name', 'id' => 'district_name', 'value' => (isset($data_info) && $data_info->name != "") ? $data_info->name : set_value('district_name'), 'minlength' => 2, 'size' => 30, 'class' => "form-control");
    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Add District</h5>
            </div>
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-lg-6">
                        <div>
                            <label for="staff_id" class="form-label">State Name</label>
                            <select class="form-select" name="state_id" id="state_id">
                                <option>Select state</option>
                                <?php foreach($states as $key=>$value) { ?>
                                <option value="<?php echo $key;?>" <?php echo (isset($data_info) && $data_info->state_id == $key) ? 'selected' : ''; ?>><?php echo $value;?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>                     
