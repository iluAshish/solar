...
$product_id = array('name' => 'product_name[]', 'id' => 'productName-1', 'class' => "form-select" ,"multiple");
                        ...
                        <table class="quotation-table table table-nowrap mb-0">
                            ...
                            <tbody id="newlink">
                                ...
                                ?>
                                    ...
                                    <td style="padding-left:0px;">
                                        <select class="form-select" name="project_id[]" id="project_id">
                                            ...
                                            <?php
                                            if (isset($data_info, $projects) && is_array($projects)) {
                                                $selectedId = (int) ($data_info->project_id ?? 0);   // cast to int once
                                                foreach ($projects as $key => $value) {
                                                    $key = (int) $key;                             // ensure both sides are int
                                                    echo '<option value="'.$key.'"'.($selectedId === $key ? ' selected' : '').'>'.htmlspecialchars($value).'</option>';
                                                }
                                            }
                                            ?>
                                        </select>
                                    ...
                                    <td>
                                        <select class="form-select size-ranges" name="project_prices[]" id="project_prices_1" data-control="projects">
                                    ...
                                    <td>
                                        <input type="text" class="form-control mb-2 mb-md-0 quantity" value="<?php echo $prod_data->qty;?>" placeholder="Enter quantity" name="qty[]" mix="99999" min="1"/>
                                        <span class="qty_error text-error"></span>
                                    <td>
                                        <input type="text" id="amount" name="amount[]" class="form-control amount" placeholder="Enter amount" value="<?php echo $prod_data->amount;?>" required />
                                    </td>    
                                ...
                                <tr>
                                    ...
                                    <td style="padding-left:0px;">
                                        <select class="form-select select-change" name="project_id[]" id="project_id_1" data-control="projects" data-name="size_ranges">
                                    ...
                                    <td>
                                        <input type="text" class="form-control mb-2 mb-md-0 rate" placeholder="Enter rate" name="rate[]" />
                                        <span class="rate_error text-error"></span>
                                    </td>
                                    <td>
                                        <input type="text" class="form-control mb-2 mb-md-0 quantity" value="0" placeholder="Enter quantity" name="qty[]" mix="99999" min="1"/>
                                        <span class="qty_error text-error"></span>
                                    </td>
                                    <td>
