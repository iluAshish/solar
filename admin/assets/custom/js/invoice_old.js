...
$(document).on("keyup", ".quantity", function (event) {
    var qty = $(this).val();
    var rate = $(this).parent().next().find('.rate').val();
    var amount = (qty * rate) ; 
...
function new_link() {
	...
	var delLink =
		...
		"</td>" + 
		"<td>" +
		'<input type="text" class="form-control mb-2 mb-md-0" placeholder="Enter quantity" name="qty[]" id="qty-' + count + '" />' +
		"</div>" +
		"</td>" +
		"<td>" +
		'<input type="text" class="form-control mb-2 mb-md-0" placeholder="Enter rate" name="rate[]" id="rate-' + count + '"/>' +
		"</td>" +
		//"<td>" +
		//'<input class="form-control bg-light border-0 product-price net-rate" type="number" id="net-rate-' + count + '" step="0.01" placeholder="0.00" name="net_rate[]" onblur="amountKeyup()">' +
		//"</td>" +
		...
		'<input type="text" class="form-control mb-2 mb-md-0" placeholder="Enter rate" id="amount-' + count + '" name="amount[]" />' +
		"</td>" +		
